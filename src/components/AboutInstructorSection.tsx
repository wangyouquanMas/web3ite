...
const AboutInstructorSection: React.FC = () => {
  ...
  const insights = [
    ...
    {
      title: '答案在行动里',
      content: '当你困惑的时候，先干起来。你不可能在一开始就知道所有答案，事情是在实践, 犯错，复盘，迭代的过程中，随着信息量的增加，逐渐清晰起来的。'
    }
  ];
            ...
            <div className={`transition-details ${isTransitionExpanded ? 'expanded' : ''}`}>
              <div className="transition-stage">
                ...
                <p>
                  ...
                  似乎我更应该选择苟在之前稳定的工作中，拿着2万5的工资，稳步上升发展。
                  但是真的有发展吗？上升的渠道还存在吗？
                </p>
                <p>
                  AI的出现，加速了35岁危机的到来。作为一个有极强危机意识的人，我可能有点过于恐慌了，
                  总之最后我选择瞒着家人，裸辞了。我的想法很简单，如果某些危机注定发生，就让它发生的早一点，趁我还年轻，
              ...
              <div className="transition-stage">
                ...
                <p>
                  但是后来还是被家里人知道我离职了，各种压力随之而来，"家庭责任感"与"内心追求"的冲突，方向不明确的迷茫，
                  同辈压力（看着身边朋友发展越来越好）导致越来越焦虑，长期难以入眠。同时储蓄渐渐减少，我开始有点慌不择路，
                  就像是游到了深水区，突然害怕，失去了基本动作，开始到处乱抓。
                </p>
                <p>
                  我尝试了各种方向：<strong>前端开发，产品经理，项目经理，运营，短视频媒体，英语口语练习</strong>。
                </p>
                <p>
                  大部分都失败了。前端因为错误认识，我以为它涉及更多的UI"美学"设计，有感性的内容在，不容易被AI替代，但实际并不是。
                  产品是因为我缺乏商业思维【每次面试必问，你的商业模式是什么？】；
                  项目经理考了证书，但它只是找相关工作的必要不充分条件。这个阶段，我犯了很多的错，但是这些错误也帮助我暴露了我的短板，
                  我的认知局限，知识自己错在哪里，接下来的问题就好办了。最可怕的应该就是，反反复复的犯着同样的错误，却不自知。
                </p>
              </div>
              ...
              <div className="transition-stage">
                ...
                <p>
                  当然也有一些收获，事实上每一次尝试后的失败，都是一次收获，它们让我加深对自己局限性的认识。当然最大的收获是意识到，
                  当你没有方向的时候，你可以选着快速试错，去尝试各种方向，快速验证可行性，可行性的验证也很简单，就是看你能不能通过面试。
                </p>
                <p>
              ...
              <div className="transition-stage">
                ...
                <p>
                  ...
                  并通过playphrase 以及AI工具来解决问题，最后通过录制英文表达视频的形式来应用我所学的新表达。
                </p>
                <p>
              ...
              <div className="transition-stage">
                ...
                <p>
                  进入web3有一些偶然性，但我觉得更多的是必然性。在做视频地过程中，有很多朋友给我介绍了web3方向，说你英语不错，结合web3，
                  能够充分发挥我的优势，提高竞争力。
                </p>
                <p>
                  自然而然地，我开始新一轮地尝试，了解了很多web3方向，最后我选择了Dex开发，它与传统互联网有很多的交叉点，
                  我的后端技能也有用得上，入行难度低一些。
                </p>
                <p>
